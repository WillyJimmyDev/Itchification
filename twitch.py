...
class Twitch(QObject):
    ...
    def get_followed(self):
        ...
        followed = self.__api_request(f"users/follows?from_id={self.user_id}&first=100")
    ...
    def _get_live_streams(self):
        ...
        for i in live_streams:
            if i not in self._live:
                ...
                self.siggy.emit(
                    ["4", "5", "6"]
                )  # should call when new streamer goes live
    ...
    def _notify_authenticated(self):
        ...
        notify_intf.Notify(
            ...
            0,
            "",
            "You are successfully authenticated with Twitch",
